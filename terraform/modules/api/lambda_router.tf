...
def upload_file():
    ...
    content_type = app.current_event.headers.get("content-type", "application/octet-stream")
...
def create_batch_inference_job():
    ...
    try:
        ...
        if error_code == "ResourceNotFoundException":
            ...
            raise ServiceError("Service is currently overloaded, please try again later")
