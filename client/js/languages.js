const languages = {
  en: {
    ...
    "email-input": {
      ...
      "data-val-email":
        "The “Email” field must be a valid email address (e.g.: example@example.com).",
    },
    "phone-label": "Phone",
    "phone-input": {
    ...
    "consent-label":
      "I consent to the collection of my personal information by Levio.",
  ...
  fr: {
    ...
    "prompt-input": {
      ...
      "data-val-phone":
        "Le champ « Téléphone » doit être une téléphone valide (ex. : 418 111 1111).",
    },
    ...
    "first-name-input": {
      ...
      "data-val-required": "Le champ « Prénom » est requis.",
    },
    "email-label": "Courriel",
    "email-input": {
      "data-val-required": "Le champ « Courriel » est requis.",
      "data-val-email":
        "Le champ « Courriel » doit être une adresse courriel valide (ex. : exemple@exemple.com).",
    },
